  ...
  return (
    <div className={`flex justify-center md:justify-between gap-x-[50px] px-[32px] lg:pr-[32px] lg:pl-[102px]  py-[30px] lg:py-[74px]  flex-col md:flex-col bg-[#67231E]`}>
      <div className="flex lg:gap-x-[102px] justify-between lg:flex-row flex-col">
        ...
        <div className=" flex footer_descriptions flex-col md:gap-x-[30px]  lg:gap-x-[52px] lg:w-[50%] lg:justify-between  md:flex-row mb-[50px] lg:mb-[0px]">
          <div className="contact md:w-[25%] forma_regular lg:w-auto mb-5 lg:mb-0">
            <PortableText value={footer.contact_email}/>
          </div>
          <div className="services md:w-[25%] forma_regular flex-col lg:flex justify-between lg:w-auto mb-5 lg:mb-0">
            <div className="forma_regular">
              <PortableText value={footer.services} />
            </div>
            <Link href={""} className="text-[13px] forma_regular  text-[#F8F3E9] tracking-[0.26px] leading-[21px]">
              Imprint
            </Link>
          </div>
          <div className="about md:w-[25%] forma_regular lg:w-auto flex-col lg:flex justify-between mb-5 lg:mb-0">
            <div className="forma_regular">
