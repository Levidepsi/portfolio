  ...
  return (
    <div className={`flex justify-center md:justify-between gap-x-[50px] px-[32px] lg:pr-[32px] lg:pl-[102px]  py-[30px] lg:py-[74px]  flex-col md:flex-col bg-[#67231E]`}>
      <div className="flex lg:gap-x-[102px] justify-between lg:flex-row flex-col">
        ...
        <div className=" flex footer_descriptions flex-col md:gap-x-[30px]  lg:gap-x-[52px] lg:w-[50%] lg:justify-between  md:flex-row mb-[20px] lg:mb-[0px]">
          <div onClick={() => handleClickAcc(0)} className={`contact ${openAccordion == 0 ? "active" : ""} w-[200px] md:w-[25%] forma_regular lg:w-auto mb-5 lg:mb-0 relative`}>
          ...
          <div onClick={() => handleClickAcc(1)} className={`services ${openAccordion == 1 ? "active" : ""} w-[200px] md:w-[25%] forma_regular relative flex-col lg:flex justify-between lg:w-auto mb-5 lg:mb-0`}>
          ...
          <div onClick={() => handleClickAcc(2)} className={`about ${openAccordion == 2 ? "active" : ""} w-[200px] md:w-[25%] relative forma_regular lg:w-auto flex-col lg:flex justify-between mb-5 lg:mb-0`}>
            <div className="forma_regular">
          ...
          <div onClick={() => handleClickAcc(3)} className={`info ${openAccordion == 3 ? "active" : ""} w-[200px] md:w-[25%] relative forma_regular lg:hidden lg:w-auto mb-5 lg:mb-0`}>
