...
import { COMPANIES_QUERY } from "../../../sanity/lib/client";
...
// 			url: `https://osprey-one.vercel.app/${slug}`,
// 			siteName: `${metaTitle}`,
// 			images: [
// 				{
...
export default async function Page(props: {
  ...
  const page = await loadQuery<SanityDocument>(COMPANIES_QUERY, {slug}, {
